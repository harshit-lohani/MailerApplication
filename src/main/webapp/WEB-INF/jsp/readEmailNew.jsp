			...
			<div class="card-body">
				<div class="col-lg-12 email-content">
						...
						<div class="email-head-subject">
							<div class="title">
								<div class="d-flex align-items-center">
									<a class="active" href="<c:url value = "/toggleStarred/${email.emailUUID }"/>">
										<span class="icon">
											<c:if test="${email.starred}">
					...
					<div class="email-attachments">
						<div class="title">
							Attachments <span>(${email.attachmentCount} files)</span>
						</div>
						<ul>
							<c:forEach var="attachment" items="${email.attachmentArray}">
								<li><a href="<c:url value = "/download/${attachment}"/>"><svg xmlns="http://www.w3.org/2000/svg"
											width="24" height="24" viewBox="0 0 24 24" fill="none"
											stroke="currentColor" stroke-width="2" stroke-linecap="round"
											stroke-linejoin="round" class="feather feather-file">
													<path
												d="M13 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9z"></path>
													<polyline points="13 2 13 9 20 9"></polyline></svg> ${attachment}
								</a></li>
							</c:forEach>
						</ul>
					</div>
